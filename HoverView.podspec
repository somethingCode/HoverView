#
#  Be sure to run `pod spec lint HoverView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/somethingCode/HoverView"
  ...
  s.source_files  = "HoverTableView", "HoverTableView/**/*.{h,m}"
  s.exclude_files = "HoverTableView/Exclude"
